...
// Shader array overflow
// visible, updated, selectable (simplify into active? + follow tree structure?)
// get old widgets to work again
// Anchor
...
namespace ui
{
    ...
    */
    ...
    public:
        ScrollBar(Canvas& p_canvas, sf::Font& p_font);
        ...
        void setIcons(const sf::Texture* p_up, const sf::Texture* p_down);
    ...
    /* A standard layout that holds a list of widgets. It allows layouting of the widgets.*/
    class Layout : public Widget
    {
    public:
        Layout(Canvas& p_canvas);

        sf::Vector2f getGroupSize() const;

        void list(Orientation p_orientation, float p_spacing);
    ...
    public:
        ...
        void setIcon(const sf::Texture* p_dropdown);
    ...
    private:
        ...
        std::function<void()> f_onDeselect;
    public:
        InputList(Canvas& p_canvas, sf::Font& p_font);
    ...
    private:
        ...
        sf::Font& font;
    public:
        ContextMenu(Canvas& p_canvas, sf::Font& p_font);
        ~ContextMenu();
        
        void setSize(const sf::Vector2f& p_size);

        void addOption(const sf::String& p_name, const std::function<void()>& p_event, ContextMenu* p_context_menu = nullptr);
    };
    ...
    */
    ...
    private:
        ...
        sf::String printWidget(Widget* p_widget, sf::String p_indent);
    };
